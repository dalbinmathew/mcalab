...
int setComplement2[n];
	...
	printf("\nS1-S2: ");
	for (int i = 0; i < n; i++)
		printf("%d ", setDifference1[i]);
	printf("\nS2-S1: ");
	for (int i = 0; i < n; i++)
		printf("%d ", setDifference2[i]);
	printf("\nS1 complement: ");
	for (int i = 0; i < n; i++)
		printf("%d ", setComplement1[i]);
	printf("\nS2 complement: ");
	for (int i = 0; i < n; i++)
		printf("%d ", setComplement2[i]);
	printf("\n");
}
